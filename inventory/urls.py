...
from .views import (
    ...
    fiscal_note_download_view, fiscal_note_delete_attachment_view, fiscal_note_upload_attachment_view
)
...
urlpatterns = [
    ...
    path('nfs/<int:pk>/attachment/', fiscal_note_download_view, name='fiscal_note_download_attachment'),
    path('nfs/<int:pk>/attachment/delete/', fiscal_note_delete_attachment_view, name='fiscal_note_delete_attachment'),
    path('nfs/<int:pk>/attachment/upload/', fiscal_note_upload_attachment_view, name='fiscal_note_upload_attachment'),
